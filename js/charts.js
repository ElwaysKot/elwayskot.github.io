document.addEventListener("DOMContentLoaded", () => {
  ...
  const cryptoData = {
    btc: {
      ...
      descriptionUa: "Помесячна динаміка ціни Bitcoin за поточний рік.",
      color: "#3efca2",
    ...
    eth: {
      ...
      descriptionUa: "Помесячна динаміка ціни Ethereum за поточний рік.",
      color: "#38bdf8",
    ...
    bnb: {
      ...
      descriptionUa: "Помесячна динаміка ціни BNB за поточний рік.",
      color: "#ffcc66",
